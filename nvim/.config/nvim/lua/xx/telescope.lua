  ...
  extensions = {
    ...
    frecency = {
      ...
      workspaces = {
        ...
        ["scanbot"] = vim.env.HOME .. "/Documents/code/scanbot",
        ["co_scan"] = vim.env.HOME .. "/Projects/sem_co_scan_ws",
        ["voxblox"] = vim.env.HOME .. "/Projects/voxblox_plusplus_ws",
        ["habitat"] = vim.env.HOME .. "/mannually_installed",
        ["habitat-lab"] = vim.env.HOME .. "/mannually_installed/habitat-lab",
        ["habitat-sim"] = vim.env.HOME .. "/mannually_installed/habitat-sim",
        ["code"] = vim.env.HOME .. "/Documents/code",
        ["note"] = vim.env.HOME .. "/Documents/Notes",
        ["wiki"] = vim.env.HOME .. "/Documents/nutstore/Vimwiki",
      },
    },
    ["ui-select"] = {
